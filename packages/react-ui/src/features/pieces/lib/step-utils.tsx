...
> = {
  ...
  [FlowActionType.MULTIPLE_CHOICE]: {
    displayName: t('Multiple Choice Question'),
    logoUrl: 'https://cdn.activepieces.com/pieces/branch.svg',
    description: t('Create a multiple choice question to get user input'),
    type: FlowActionType.MULTIPLE_CHOICE as const,
  },
...
export const CORE_ACTIONS_METADATA = [
  ...
  CORE_STEP_METADATA[FlowActionType.MULTIPLE_CHOICE],
] as const;
...
export const MULTIPLE_CHOICE_ACTION = 'createMultipleChoiceQuestion';
...
export const stepUtils = {
      ...
      case FlowTriggerType.PIECE: {
        ...
        const isEndPiece =
          step.type === FlowActionType.PIECE
            ? piece.actions[step.settings.actionName!]?.isEndPiece
            : piece.triggers[step.settings.triggerName!]?.isEndPiece;

        console.log(`[EndFlowDebug] Piece: ${step.settings.pieceName}, isEndPiece: ${isEndPiece}`);
        ...
        return {
          ...
          actionOrTriggerOrAgentDisplayName: t(actionOrTriggerDisplayName),
        };
      }
    }
  },
  mapPieceToMetadata({
    ...
    return {
      displayName: t(piece.displayName),
      logoUrl: piece.logoUrl,
      description: t(piece.description),
