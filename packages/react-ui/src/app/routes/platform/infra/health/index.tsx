  ...
  const healthData = [
    ...
    },
    {
      ...
      details: socket.connected
        ...
        : t('Connection issues detected.<br>Visit the <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://www.activepieces.com/docs/install/configuration/troubleshooting" target="_blank">troubleshooting guide</a> for more details.'),
        ...
        columns={[
          {
            accessorKey: 'check',
            header: ({ column }) => (
              <DataTableColumnHeader column={column} title={t('Test')} />
            ),
          },
          {
            accessorKey: 'status',
