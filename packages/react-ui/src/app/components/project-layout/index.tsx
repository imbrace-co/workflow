...
export function ProjectDashboardLayout({
  ...
  if ((isNil(currentProjectId) || currentProjectId === '') && !hasExternalAuth) {
    console.warn('No project ID found in the authentication session.');
  ...
  return (
    <ProjectChangedRedirector currentProjectId={currentProjectId} hasExternalAuth={hasExternalAuth}>
      <SidebarProvider>
