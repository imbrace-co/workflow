...
const baseUrl = 'https://api.paperform.co/v1';
...
export const paperformCommon = {
  ...
  async getSpaces({
    ...
    return apiCall<PaperformSpacesResponse>({
  ...
  async getForms({
    ...
    return apiCall<PaperformFormsResponse>({
      method: HttpMethod.GET,
  ...
  async getFormFields({
    ...
    return apiCall<PaperformFieldsResponse>({
      method: HttpMethod.GET,
  ...
  async getSubmissions({
    ...
    return apiCall<PaperformSubmissionsResponse>({
      method: HttpMethod.GET,
  ...
  async getPartialSubmissions({
    ...
    return apiCall<PaperformPartialSubmissionsResponse>({
      method: HttpMethod.GET,
  ...
  async getCoupons({
    ...
    return apiCall<PaperformCouponsResponse>({
      method: HttpMethod.GET,
  ...
  async getProducts({
    ...
    return apiCall<PaperformProductsResponse>({
      method: HttpMethod.GET,
  ...
  async getSubmission({
    ...
    return apiCall<{results:{submission:PaperformSubmission}}>({
      method: HttpMethod.GET,
  ...
  async getPartialSubmission({
    ...
    return apiCall<{results:{'partial-submission':PaperformSubmission}}>({
      method: HttpMethod.GET,
  ...
  async createWebhook({
    ...
    return apiCall<PaperformWebhookResponse>({
