import { DynamicPropsValue, Property, InputPropertyMap } from '@activepieces/pieces-framework';
import {
  httpClient,
  HttpMethod,
  HttpRequest,
...
export const getFields = (type: 'contact' | 'company' | 'lead') =>
  Property.DynamicProperties({
    ...
    props: async ({ auth }) => {
      ...
      return (await fetchDynamicFieldsFromMetadata(base_url, username, password, type)) as unknown as InputPropertyMap;
    },
  });
