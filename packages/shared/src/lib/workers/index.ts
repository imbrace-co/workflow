...
export const WorkerSettingsResponse = Type.Object({
    ...
    KAFKA_CLIENT_ID: Type.Optional(Type.String()),
    KAFKA_ENDPOINT: Type.Optional(Type.String()),
    KAFKA_USE_SSL: Type.Optional(Type.Boolean()),
    KAFKA_USE_SASL: Type.Optional(Type.Boolean()),
    KAFKA_SASL_MECHANISM: Type.Optional(Type.String()),
    KAFKA_SASL_USERNAME: Type.Optional(Type.String()),
    KAFKA_SASL_PASSWORD: Type.Optional(Type.String()),
    KAFKA_PARTITION: Type.Optional(Type.String()),
    KAFKA_IS_AWS_KAFKA: Type.Optional(Type.String()),
    KAFKA_AWS_REGION: Type.Optional(Type.String()),
    ...
    EDITION: Type.String(),
    IMBRACE_API_DOMAIN: Type.Optional(Type.String()),
    IMBRACE_PRIVATE_API: Type.Optional(Type.String()),
    IMBRACE_DATABOARD_API: Type.Optional(Type.String()),
    IMBRACE_API_OLD_DOMAIN: Type.Optional(Type.String()),
    IMBRACE_DEMO_API_OLD_DOMAIN: Type.Optional(Type.String()),
    IMBRACE_DEMO_API_DOMAIN: Type.Optional(Type.String()),
    DOCUMENT_API_VERSION: Type.Optional(Type.String()),
    PLATFORM_SERVICE_API: Type.Optional(Type.String()),
    APWF_API_URL: Type.Optional(Type.String()),
