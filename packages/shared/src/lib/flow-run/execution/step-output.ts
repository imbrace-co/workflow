...
export type StepOutput =
  ...
  | GenericStepOutput<FlowActionType.ROUTER | FlowActionType.MULTIPLE_CHOICE, unknown>
  | GenericStepOutput<
  | Exclude<FlowActionType, FlowActionType.LOOP_ON_ITEMS | FlowActionType.ROUTER | FlowActionType.MULTIPLE_CHOICE>
  | FlowTriggerType,
  unknown
  >
...
FlowActionType.ROUTER | FlowActionType.MULTIPLE_CHOICE,
RouterStepResult
> {
