...
function getEnvironmentVariables(): Record<string, string | undefined> {
    ...
    return {
        ...
        KAFKA_ENABLED: environmentVariables.getSysEnvironment("KAFKA_ENABLED"),
        KAFKA_CLIENT_ID: environmentVariables.getSysEnvironment("KAFKA_CLIENT_ID"),
        KAFKA_ENDPOINT: environmentVariables.getSysEnvironment("KAFKA_ENDPOINT"),
        KAFKA_USE_SSL: environmentVariables.getSysEnvironment("KAFKA_USE_SSL"),
        KAFKA_USE_SASL: environmentVariables.getSysEnvironment("KAFKA_USE_SASL"),
        KAFKA_SASL_MECHANISM: environmentVariables.getSysEnvironment("KAFKA_SASL_MECHANISM"),
        KAFKA_SASL_USERNAME: environmentVariables.getSysEnvironment("KAFKA_SASL_USERNAME"),
        KAFKA_SASL_PASSWORD: environmentVariables.getSysEnvironment("KAFKA_SASL_PASSWORD"),
        KAFKA_PARTITION: environmentVariables.getSysEnvironment("KAFKA_PARTITION"),
        KAFKA_IS_AWS_KAFKA: environmentVariables.getSysEnvironment("KAFKA_IS_AWS_KAFKA"),
        KAFKA_AWS_REGION: environmentVariables.getSysEnvironment("KAFKA_AWS_REGION"),
        REDIS_HOST: environmentVariables.getSysEnvironment("REDIS_HOST"),
        REDIS_PORT: environmentVariables.getSysEnvironment("REDIS_PORT"),
        REDIS_USERNAME: environmentVariables.getSysEnvironment("REDIS_USERNAME"),
        REDIS_PASSWORD: environmentVariables.getSysEnvironment("REDIS_PASSWORD"),
        REDIS_DB: environmentVariables.getSysEnvironment("REDIS_DB"),
        REDIS_TLS: environmentVariables.getSysEnvironment("REDIS_TLS"),
        REDIS_TLS_REJECT_UNAUTHORIZED: environmentVariables.getSysEnvironment("REDIS_TLS_REJECT_UNAUTHORIZED"),
        AWS_ACCESS_KEY_ID: environmentVariables.getSysEnvironment("AWS_ACCESS_KEY_ID"),
        AWS_SECRET_ACCESS_KEY: environmentVariables.getSysEnvironment("AWS_SECRET_ACCESS_KEY"),
        AWS_REGION: environmentVariables.getSysEnvironment("AWS_REGION"),
        IMBRACE_PRIVATE_API: environmentVariables.getSysEnvironment("IMBRACE_PRIVATE_API"),
        IMBRACE_DATABOARD_API: environmentVariables.getSysEnvironment("IMBRACE_DATABOARD_API"),
        IMBRACE_CHANNEL_API: environmentVariables.getSysEnvironment("IMBRACE_CHANNEL_API"),
        IMBRACE_LEGACY_APPS_API: environmentVariables.getSysEnvironment("IMBRACE_LEGACY_APPS_API"),
        IMBRACE_API_DOMAIN: environmentVariables.getSysEnvironment("IMBRACE_API_DOMAIN"),
        IMBRACE_API_OLD_DOMAIN: environmentVariables.getSysEnvironment("IMBRACE_API_OLD_DOMAIN"),
        IMBRACE_DEMO_API_OLD_DOMAIN: environmentVariables.getSysEnvironment("IMBRACE_DEMO_API_OLD_DOMAIN"),
        IMBRACE_DEMO_API_DOMAIN: environmentVariables.getSysEnvironment("IMBRACE_DEMO_API_DOMAIN"),
        DOCUMENT_API_VERSION: environmentVariables.getSysEnvironment("DOCUMENT_API_VERSION"),
        APWF_API_URL: environmentVariables.getSysEnvironment("APWF_API_URL"),
        GATEWAY_URL: environmentVariables.getSysEnvironment("GATEWAY_URL"),
        MESSAGE_SUGGESTION_API: environmentVariables.getSysEnvironment("MESSAGE_SUGGESTION_API"),
        PLATFORM_SERVICE_API: environmentVariables.getSysEnvironment('PLATFORM_SERVICE_API')
    }
}