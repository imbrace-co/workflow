...
import { SeedDefaultPlatformAndUser1779432078059 } from './migration/postgres/1779432078059-SeedDefaultPlatformAndUser'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const commonMigration = [
        ...
        SeedDefaultPlatformAndUser1779432078059,
    ]

    // COMMUNITY edition only: no enterprise migrations.
