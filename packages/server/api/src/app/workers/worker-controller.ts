...
export const flowWorkerController: FastifyPluginAsyncTypebox = async (app) => {
    ...
    app.post('/submit-payloads', {
        ...
        return tracer.startActiveSpan('worker.submitPayloads', {
            ...
            try {
                const { flowVersionId, projectId, payloads, httpRequestId, synchronousHandlerId, progressUpdateType, environment, parentRunId, failParentOnFailure, platformId, orgId, imbraceToken } = request.body
