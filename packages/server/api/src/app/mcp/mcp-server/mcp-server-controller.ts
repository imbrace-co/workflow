import { apId, ApId, CreateMcpRequestBody, ListMcpsRequest, McpWithTools, Nullable, Permission, PrincipalType, SeekPage, SERVICE_KEY_SECURITY_OPENAPI, UpdateMcpRequestBody, UserPrincipal } from '@activepieces/shared'
...
export const mcpServerController: FastifyPluginAsyncTypebox = async (app) => {
    ...
    app.get('/', GetMcpsRequest, async (req) => {
        const projectId = (req.principal as UserPrincipal).projectId
