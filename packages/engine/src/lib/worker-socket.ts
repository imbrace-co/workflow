...
const BACKEND_URL = process.env.AP_BACKEND_URL || 'http://127.0.0.1:3000'
const ENGINE_WS_PORT = process.env.AP_ENGINE_WS_PORT || '12345'
const WS_URL = BACKEND_URL.replace(/^https?:\/\//, 'ws://').replace(/:\d+$/, `:${ENGINE_WS_PORT}`) 
