...
export class EngineConstants {
    ...
    public static readonly PIECES_SOURCE = (process.env.AP_PIECES_SOURCE ?? 'DB') as 'FILE' | 'DB' | 'BUILTIN'
    ...
    public readonly imbraceToken?: string
    ...
    public get pieceSource(): 'FILE' | 'DB' | 'BUILTIN' {
        return EngineConstants.PIECES_SOURCE
    }
    ...
    public constructor(params: EngineConstantsParams) {
        ...
        this.imbraceToken = params.imbraceToken
    }
    ...
    public static fromExecuteFlowInput(input: ExecuteFlowOperation): EngineConstants {
        return new EngineConstants({
            ...
            imbraceToken: input.imbraceToken,
            orgId: input.orgId,
